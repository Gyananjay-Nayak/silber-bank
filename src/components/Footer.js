      ...
      <div className="footer-wrapper">
        ...
        <Container>
          ...
          <p>
            ...
            Opening any deposit, savings, cryptocurrency or trading accounts
            with the bank is subject to approval, know your customer, AML and
            KYT and Travel Rule procedures and registration to the website
            itself doesn't constitute account approval.
          </p>
          <p>
            ...
            for registered users is general in nature and doesn't consider your
          ...
          <div className="text-center">
            <span>©Copyright 2024 Silber Private Bank | All Rights Reserved</span>
          </div>
        </Container>
      </div>
    </footer>
